...
def lookup_table(series1, table2, table2_lookup_column, table2_return_column):
    return series1.map(table2.set_index(table2_lookup_column)[table2_return_column])
